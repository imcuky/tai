...
| Source Folder | Category | Confidence | Files | Destination |
|---------------|----------|------------|-------|-------------|
| `articles` | support | 0.92 | 28 | `support/articles` |
| `assets` | study | 0.94 | 136 | `study/lecture/assets` |
| `assignment-calendar` | support | 0.93 | 2 | `support/assignment-calendar` |
| `disc` | study | 0.93 | 98 | `study/lecture/disc` |
| `exam` | support | 0.87 | 324 | `support/exam` |
| `hw` | practice | 0.96 | 66 | `practice/hw` |
| `instructor` | support | 0.96 | 2 | `support/instructor` |
| `lab` | practice | 0.96 | 92 | `practice/lab` |
| `lecture` | study | 0.72 | 2 | `study/lecture` |
| `office-hours` | support | 0.90 | 2 | `support/office-hours` |
| `proj` | practice | 0.95 | 368 | `practice/proj` |
| `resources` | support | 0.74 | 2 | `support/resources` |
| `staff` | support | 0.96 | 2 | `support/staff` |
| `study-guide` | study | 0.90 | 2 | `study/lecture/study-guide` |
| `textbook` | support | 0.77 | 94 | `support/textbook` |
| `youtube` | study | 0.86 | 1413 | `study/lecture/youtube` |

## Folder Structure (no files)
